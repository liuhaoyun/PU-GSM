...
parser.add_argument('--epoch_per_save', type=int, default=3)
...
parser.add_argument('--fidelity_w', default=8000.0, type=float, help="fidelity_weight")
parser.add_argument('--emd_w', default=50.0, type=float, help="emd_weight")
parser.add_argument('--coarse_w', default=500.0, type=float, help="coarse_weight")
parser.add_argument('--twin_w', default=50.0, type=float, help="twin_weight")
